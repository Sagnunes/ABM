...
class AreaOrgController extends Controller
{
    public function index(){
        return view('extras.areaorg.index')->with('results',AreaOrg::orderBy('nome')->get());
    }
    public function create(){
        return view('extras.areaorg.create');
    }
    ...
    public function edit($slug){
        return view('extras.areaorg.edit')->with('results',AreaOrg::where('slug',$slug)->first());
    }

    public function update(ExtraFormValidation $request , $id){

        try {
            $registo = AreaOrg::findOrFail($id);
        ...
        return redirect()->route('areaorg.index');
    }
    public function destroy($id)
    {
        $registo = AreaOrg::find($id);
        $registo->delete();
