...
class MunicipioController extends Controller
{
    public function index(){
        return view('extras.municipio.index')->with('results',Municipio::orderBy('nome')->get());
    }
    public function create(){
        return view('extras.municipio.create');
    }
    ...
    public function edit($slug){
        return view('extras.municipio.edit')->with('results',Municipio::where('slug',$slug)->first());
    }

    public function update(ExtraFormValidation $request , $id){

        try {
            $registo = Municipio::find($id);
