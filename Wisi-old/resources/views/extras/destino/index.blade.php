...
@endsection
@section('content')
    @include('extras.destino.alert-modal-delete')
                ...
                <div class="m-portlet__body">
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('destino.edit',['slug'=>$item->slug])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Editar detalhes">
