...
@endsection
@section('content')
    @include('extras.oficiosessao.alert-modal-delete')
                    ...
                    <table class="m-datatable" id="html_table" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="{{route('oficiosessao.edit',['slug'=>$item->slug])}}" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Editar detalhes">
