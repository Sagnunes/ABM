    ...
    <div class="m-form m-form--fit m-form--label-align-right">
        <div class="m-portlet__body">
            ...
            <div class="m-portlet">
                ...
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('marcaagua.update',['id'=>$registo->id])}}" enctype="multipart/form-data" method="POST">
                    @csrf
                    @method('put')
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('tema') ? ' is-invalid' : '' }}" value="{{$registo->tema}}" name="tema"/>
                                @if ($errors->has('tema'))
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('subTema') ? ' is-invalid' : '' }}" value="{{$registo->subTema}}" name="subTema"/>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('cota') ? ' is-invalid' : '' }}" value="{{$registo->cota}}" name="cota"/>
                                @if ($errors->has('cota'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control m-input{{ $errors->has('resumo') ? ' is-invalid' : '' }}" value="{{$registo->resumo}}" name="resumo">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="date" class="form-control m-input{{ $errors->has('data') ? ' is-invalid' : '' }}" value="{{$registo->data}}" name="data"/>
                                @if ($errors->has('data'))
                                    <span class="invalid-feedback">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('folio') ? ' is-invalid' : '' }}" value="{{$registo->folio}}" name="folio"/>
                                @if ($errors->has('folio'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="file" class="form-control m-input{{ $errors->has('file') ? ' is-invalid' : '' }}" name="file"/>
                                @if ($errors->has('file'))
                                    <span class="invalid-feedback">
