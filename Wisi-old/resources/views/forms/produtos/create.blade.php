                    ...
                    <form action="{{route('produto.store')}}" method="post">
                        <div class="m-portlet__body">
                            ...
                            <div class="form-group m-form__group row">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control m-input{{ $errors->has('stock') ? ' is-invalid' : '' }}"  value="{{old('stock')}}" name="stock"/>
                                    @if ($errors->has('stock'))
                                        <span class="invalid-feedback">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="form-control m-input{{ $errors->has('stock_minimo') ? ' is-invalid' : '' }}" value="{{old('stock_minimo')}}" name="stock_minimo"/>
