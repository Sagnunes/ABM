                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                Novo registo de processo de obras
                            </h3>
                        </div>
                    </div>
                </div>
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('processoObra.store')}}" method="post">
                    @csrf
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="number" class="form-control m-input{{ $errors->has('cota') ? ' is-invalid' : '' }}" value="{{old('cota')}}" name="cota"/>
                                @if ($errors->has('cota'))
                            ...
                            <div class="col-lg-3">
                                <input type="number" class="form-control m-input{{ $errors->has('documento') ? ' is-invalid' : '' }}" value="{{old('documento')}}" name="documento"/>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="number" class="form-control m-input{{ $errors->has('volume') ? ' is-invalid' : '' }}" value="{{old('volume')}}" name="volume"/>
                            ...
                            <div class="col-lg-3">
                                <input type="number" class="form-control m-input{{ $errors->has('projeto') ? ' is-invalid' : '' }}" value="{{old('projeto')}}" name="projeto"/>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('tipo_obra') ? ' is-invalid' : '' }}" value="{{old('tipo_obra')}}" name="tipo_obra"/>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control m-input{{ $errors->has('objeto') ? ' is-invalid' : '' }}" name="objeto" value="{{old('objeto')}}">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control m-input{{ $errors->has('sitio') ? ' is-invalid' : '' }}" name="sitio" value="{{old('sitio')}}">
                                @if ($errors->has('sitio'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control m-input{{ $errors->has('localizacao') ? ' is-invalid' : '' }}" name="localizacao" value="{{old('localizacao')}}">
