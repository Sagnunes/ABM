                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                Novo registo de notariais
                            </h3>
                        </div>
                    </div>
                </div>
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('notariais.store')}}" method="post">
                    @csrf
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('livro') ? ' is-invalid' : '' }}" value="{{old('livro')}}" name="livro" style="font-size: 18px; font-weight: bold"/>
                                @if ($errors->has('livro'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group m-form__group row ">
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-12">
                                <textarea name="outorgante" class="form-control{{ $errors->has('outorgante') ? ' is-invalid' : '' }}" data-provide="markdown" rows="7">{{old('outorgante')}}</textarea>
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-12">
                                <textarea name="outros" class="form-control{{ $errors->has('outros') ? ' is-invalid' : '' }}" data-provide="markdown" rows="7">{{old('outros')}}</textarea>
                            </div>
                        </div>
                        <div class="form-group m-form__group row">
                            <label class="col-lg-3 col-form-label">
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-12">
                                <textarea name="objTrans" class="form-control{{ $errors->has('objTrans') ? ' is-invalid' : '' }}" data-provide="markdown" rows="7">{{old('objTrans')}}</textarea>
                            </div>
                        </div>
                        <div class="form-group m-form__group row m--margin-top-10">
                            <label class="col-lg-3 col-form-label">
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-12">
                                <textarea name="observacao" class="form-control{{ $errors->has('observacao') ? ' is-invalid' : '' }}" data-provide="markdown" rows="10">{{old('observacao')}}</textarea>
                            </div>
                        </div>
