    ...
    <div class="m-form m-form--fit m-form--label-align-right">
        <div class="m-portlet__body">
            ...
            <div class="m-portlet">
                    ...
                    <div class="m-portlet__head-caption">
                        <div class="m-portlet__head-title">
                            ...
                            <h3 class="m-portlet__head-text">
                                Judiciais <br><span class="m-form__help text-lighter" style="text-decoration: underline">
                ...
                <!--begin::Form-->
                <form class="m-form m-form--fit m-form--label-align-right m-form--group-seperator-dashed" action="{{route('judicial.update',['id'=>$registo->id])}}" method="post">
                    @csrf
                    @method('put')
                    ...
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('caixa') ? ' is-invalid' : '' }}"  value="{{$registo->caixa or old('caixa')}}" name="caixa"/>
                                @if ($errors->has('caixa'))
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('numero') ? ' is-invalid' : '' }}" value="{{$registo->numero or old('numero')}}" name="numero"/>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('numeroProcesso') ? ' is-invalid' : '' }}" value="{{$registo->numeroProcesso or old('numeroProcesso')}}" name="numeroProcesso">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('dataInicial') ? ' is-invalid' : '' }}" value="{{$registo->dataInicial or old('dataInicial')}}" name="dataInicial">
                            ...
                            <div class="col-lg-3">
                                <input type="text" class="form-control m-input{{ $errors->has('dataFinal') ? ' is-invalid' : '' }}" value="{{$registo->dataFinal or old('dataFinal')}}" name="dataFinal">
                        ...
                        <div class="form-group m-form__group row justify-content-center">
                            ...
                            <div class="col-lg-4">
                                <select class="form-control m-select2{{ $errors->has('tribunal') ? ' is-invalid' : '' }}" id="m_select2_clear_1" name="tribunal">
                                    @if($tribunal->count() >0)
                                        <option value="{{$registo->tribunal_id}}">{{$registo->tribunal->nome}}</option>
                            ...
                            <div class="col-lg-4">
                                <select class="form-control m-select2{{ $errors->has('juizo') ? ' is-invalid' : '' }}" id="m_select2_clear_2" name="juizo">
                                    @if($juizo->count() >0)
                                        <option value="{{$registo->varaJuizo_id}}">{{$registo->varajuizo->nome}}</option>
                        ...
                        <div class="form-group m-form__group row justify-content-center">
                            ...
                            <div class="col-lg-4">
                                <select class="form-control m-select2{{ $errors->has('classificacao') ? ' is-invalid' : '' }}" id="m_select2_clear_3" name="classificacao">
                                    @if($classificacao->count() >0)
                                        <option value="{{$registo->classificacao_id}}">{{$registo->classificacao->nome}}</option>
                            ...
                            <div class="col-lg-4">
                                <select class="form-control m-select2{{ $errors->has('oficio') ? ' is-invalid' : '' }}" id="m_select2_clear_4" name="oficio">
                                    @if($oficio->count() >0)
                                        <option value="{{$registo->oficio_seccao_id}}">{{$registo->oficioseccao->nome}}</option>
                            ...
                            <div class="col-lg-8">
                                <select class="form-control m-select2{{ $errors->has('tipologia') ? ' is-invalid' : '' }}" id="m_select2_clear_5" name="tipologia">
                                    @if($tipologia->count() >0)
                                        <option value="{{$registo->tipologiaJudicial_id}}">{{$registo->tipologia->nome}}</option>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control m-input{{ $errors->has('autor') ? ' is-invalid' : '' }}"  value="{{$registo->autor or old('autor')}}" name="autor"/>
                                @if ($errors->has('autor'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-8">
                                <input type="text" class="form-control m-input{{ $errors->has('reu') ? ' is-invalid' : '' }}" value="{{$registo->reu or old('reu')}}" name="reu"/>
                                @if ($errors->has('reu'))
                                    <span class="invalid-feedback">
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-12">
                                <textarea name="assuntos" class="form-control{{ $errors->has('assuntos') ? ' is-invalid' : '' }}" data-provide="markdown" rows="6">{{$registo->assuntos or old('assuntos')}}</textarea>
                        ...
                        <div class="form-group m-form__group row">
                            ...
                            <div class="col-lg-12 col-md-9 col-sm-12">
                                <textarea name="apensos" class="form-control{{ $errors->has('apensos') ? ' is-invalid' : '' }}" data-provide="markdown" rows="10">{{$registo->anexo or old('apensos')}}</textarea>
