...
var Select2 = function() {
    ...
    var demos = function() {
        ...
        $('#m_select2_clear_1').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
        $('#m_select2_clear_2').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
        $('#m_select2_clear_3').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
        $('#m_select2_clear_4').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
        $('#m_select2_clear_5').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
        $('#m_select2_clear_6').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
        $('#m_select2_clear_7').select2({
            placeholder: "Escolher uma opção",
            allowClear: true
        });
